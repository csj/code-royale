...
class AllGiantsPlayer(stdin: InputStream, stdout: PrintStream, stderr: PrintStream) : BasePlayer(stdin, stdout, stderr) {
    ...
    init {
        ...
        while (true) {
            ...
            fun getQueenAction(): String {
                ...
                return "BUILD ${queenTarget.obstacleId} ${if (needsBarracks) "BARRACKS-GIANT" else "MINE"}"
            }
